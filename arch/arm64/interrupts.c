...
extern void enable_exceptions(void);
extern void vectors(void); //declaring it as a function gives you the address pointer
void interrupt_exception_handler(uint32_t exc_type, arm64_registers_t *regs);
