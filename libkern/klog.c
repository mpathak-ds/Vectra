...
{
    switch (level) {
        case Debug:    return COLOR_CYAN "[debug]" COLOR_RESET;
        case Info:     return COLOR_CYAN "[info]" COLOR_RESET;
        case Notice:   return COLOR_BLUE "[notice]" COLOR_RESET;
        case Warning:  return COLOR_YELLOW "[warning]" COLOR_RESET;
        case Error:    return COLOR_RED "[error]" COLOR_RESET;
        case Critical: return COLOR_RED "[critical]" COLOR_RESET;
        case Panic:    return COLOR_RED "[panic]" COLOR_RESET;
    }
...
DEFINE_KLOG_FUNCTION(klog_info,     Info)
DEFINE_KLOG_FUNCTION(klog_notice,   Notice)
DEFINE_KLOG_FUNCTION(klog_warn,     Warning)
DEFINE_KLOG_FUNCTION(klog_error,    Error)
DEFINE_KLOG_FUNCTION(klog_critical, Critical)
DEFINE_KLOG_FUNCTION(klog_debug,    Debug)
DEFINE_KLOG_FUNCTION(klog_panic,    Panic)
